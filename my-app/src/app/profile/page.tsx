...
export default function ProfilePage() {
    ...
    return (
        <div className="p-4 pt-20 md:p-6 md:pt-6 w-full space-y-6 md:space-y-6 relative animate-in fade-in duration-500 pb-24 h-full overflow-y-auto">

            {/* User Info Card */}
            <div className="group bg-card border border-cyan-500 rounded-2xl overflow-hidden shadow-sm hover:shadow-md transition-all duration-300 flex flex-col">
                {/* Banner */}
                <div className="h-32 sm:h-40 bg-linear-to-r from-primary/20 via-primary/10 to-transparent relative shrink-0">
            ...
            {/* Heatmap Section */}
            <div className="bg-card/50 backdrop-blur-md border border-cyan-500 rounded-2xl p-6 shadow-lg space-y-6 relative overflow-hidden min-h-[300px] max-w-full">
            ...
            {selectedTopic && (
                ...
                >
                    ...
                    >
                        <div className="h-24 bg-linear-to-r from-primary/10 to-transparent relative border-b border-border/50">
                            {/* Banner Decoration */}
                            <div className="absolute inset-0 bg-grid-black/5 mask-[linear-gradient(0deg,white,transparent)] dark:bg-grid-white/5" />
                                    ...
                                    <div key={idx} className="group flex items-center justify-between p-3 rounded-xl border border-border/40 hover:border-primary/30 hover:bg-muted/30 transition-all duration-200">
                                        ...
                                        <div className="flex items-center gap-1 opacity-70 group-hover:opacity-100 transition-opacity">
                                            {[1, 2, 3, 4, 5].map((star) => (
                                                <Star
                                                    key={star}
                                                    className={`h-3.5 w-3.5 transition-colors duration-300 ${star <= sub.confidence
